...
for i = 1 : total_Images
    ...
    Screen('DrawText', window, 'Loading...', x_center-715, y_center+410); % Write text to confirm loading of images
    Screen('DrawText', window, [int2str(int16(i*100/147)) '%', 5, y_center+410]); % Write text to confirm percentage complete
